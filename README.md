...
Our first objective is to build a series of scatter plots to showcase the following relationships:
...
* We create a heat map that displays the humidity for every city from the part I.
